...
const Info = () => {
    ...
    return (
       <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 px-5 mt-36'>           
            ...
            <InfoCart cartTitle={information[1].title} cartInfo={information[0].details} bgClass='bg-accent' img={marker}></InfoCart>
            <InfoCart cartTitle={information[2].title} cartInfo={information[0].details} bgClass='bg-secondary' img={phone}></InfoCart>
       </div>
    );
};
